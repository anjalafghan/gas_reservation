...
<form id="form" action="change_location.php" method="post">
   <div class="container">
    <div class="row">
      <div class="six columns">
        <label for="address">Address</label>
  <textarea class="u-full-width" placeholder="address" name="address" id="address" ></textarea>
    </div>
    </div>

  <div class="row">
    <input class="button-primary"  onclick="submitForm()" type="submit" name="submit" value="Change Location">
  </div>
  </div>
</form>
